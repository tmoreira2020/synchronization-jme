   ...
   */
	...
	*/
	public void initReceiveCode() throws NotFoundException {
		addReceiveCode("this." + fieldName
			+ "= org.floggy.synchronization.jme.core.impl.JSONSerializationManager.receiveStack(\""
	...
	*/
	public void initSendCode() throws NotFoundException {
		addSendCode(
			"org.floggy.synchronization.jme.core.impl.JSONSerializationManager.sendStack(\""
