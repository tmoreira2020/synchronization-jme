 ...
 */
package org.floggy.synchronization.jme.sample;
...
import org.floggy.synchronization.jme.sample.gui.MainForm;
...
* @version $Revision$
 */
public class WCTMIDlet extends MIDlet {
	static Display display;
	static WCTMIDlet midlet;
	static Exception exception;

/**
   * Creates a new WCTMIDlet object.
   */
	public WCTMIDlet() {
		super();
