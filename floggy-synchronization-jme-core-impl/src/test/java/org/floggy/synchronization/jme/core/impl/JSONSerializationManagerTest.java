...
public class JSONSerializationManagerTest extends TestCase {
	...
	*/
	public void testSendCalendarNotNull() throws Exception {
		...
		String expected =
			"{\"bornDate\":{\"ID\":\"America/Sao_Paulo\",\"time\":1234567890}}";
