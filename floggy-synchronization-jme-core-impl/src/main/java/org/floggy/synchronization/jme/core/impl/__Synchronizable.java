 ...
 * @version $Revision$
  */
public interface __Synchronizable extends Synchronizable {
	/**
	* DOCUMENT ME!
	*
	...
	*/
	public void __receive(JSONObject jsonObject) throws Exception;
	...
	* @throws Exception DOCUMENT ME!
	*/
	public void __send(JSONStringer stringer) throws Exception;
}
